function main_STM_Earth_Mars_high_fidelity_transfer
clear all;
...
% options = optimoptions('fmincon','Display','iter','Algorithm','sqp','TolFun',1.0e-12,'TolX',1.0e-12,'StepTolerance',1.0e-12,'PlotFcns',@optimplotfval,'MaxFunctionEvaluations',2000);
...
% options = optimoptions('fmincon','Display','iter','Algorithm','active-set','TolFun',1.0e-12,'TolX',1.0e-12,'StepTolerance',1.0e-15,'PlotFcns',@optimplotfval,'MaxFunctionEvaluations',2000);
